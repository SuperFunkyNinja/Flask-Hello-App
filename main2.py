...
def index():
    ...
    if pan_value:
        pan_value = tilt_value_from(pan_value)
    if tilt_value:
        tilt_value = pan_value_from(tilt_value)
    return (
        """<form action="" method="get">
                Pan Value: <input type="text" name="pan_value">
                Tilt Value: <input type="text" name="tilt_value">
